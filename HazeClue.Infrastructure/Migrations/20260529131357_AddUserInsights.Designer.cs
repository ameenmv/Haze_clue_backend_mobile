...
namespace HazeClue.Infrastructure.Migrations
{
    ...
    [Migration("20260529131357_AddUserInsights")]
    partial class AddUserInsights
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HazeClue.Core.Domain.Entities.FocusSession", b =>
                {
                    ...
                    b.Property<int>("AverageConcentration")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HazeClue.Core.Domain.Entities.SmartwatchData", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("SmartwatchData");
                });

            modelBuilder.Entity("HazeClue.Core.Domain.Entities.UserInsight", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
